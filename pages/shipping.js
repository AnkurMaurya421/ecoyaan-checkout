...
export default function Shipping() {
  ...
  // Redirect to cart if no addresses and user tries to continue without adding one
  ...
  const handleDelete = (id) => {
    ...
    if (selectedAddress?.id === id) {
      // Set to first remaining address, or null if none
      const newSelected = newAddresses.length > 0 ? newAddresses[0] : null;
...
// Function to handle continue button click - validate selection and navigate to payment page
